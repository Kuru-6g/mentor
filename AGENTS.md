...
## Project Context: Mentor

You are assisting with the `mentor` project, which is a web application (Vite-based React/TypeScript) for a mentorship platform.

- **Stack**: React, TypeScript, Vite, Supabase.
- **Goal**: Provide a platform for mentors and mentees to connect.
- **Core Files**:
  - `src/`: Contains source code.
  - `src/screens/`: Page components.
  - `src/components/`: Reusable UI components.
  - `src/services/`: Supabase and other service integrations.
- **Constraints**: Follow existing coding styles and use Supabase for authentication and database.
